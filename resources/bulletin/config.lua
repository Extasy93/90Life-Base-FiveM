...
cfg_bulletin.Timeout          = 7500          -- Overridden by the `timeout` param
cfg_bulletin.Position         = GetResourceKvpString("notif_position") or "bottomleft"
cfg_bulletin.Progress         = true          -- Overridden by the `progress` param
cfg_bulletin.Theme            = "default"     -- Overridden by the `theme` param
cfg_bulletin.Queue            = 5             -- No. of notifications to show before queueing
cfg_bulletin.Stacking         = true
cfg_bulletin.ShowStackedCount = true
cfg_bulletin.AnimationIn      = "fadeIn";     -- Enter animation - 'fadeOut', 'fadeOutLeft', 'flipOutX', 'flipOutY', 'bounceOutLeft', 'backOutLeft', 'slideOutLeft', 'zoomOut', 'zoomOutLeft'
cfg_bulletin.AnimationOut     = "fadeOut";    -- Exit animation - 'fadeOut', 'fadeOutLeft', 'flipOutX', 'flipOutY', 'bounceOutLeft', 'backOutLeft', 'slideOutLeft', 'zoomOut', 'zoomOutLeft'
cfg_bulletin.AnimationTime    = 350           -- Entry / exit animation interval
cfg_bulletin.SoundFile        = true          -- Sound file stored in ui/audio used for notification sound. Leave as false to disable.
cfg_bulletin.SoundVolume      = 0.4           -- 0.0 - 1.0
...
cfg_bulletin.Pictures = {
    PLANE_EVENT                      = "PLANE_EVENT.png",
    CHAR_ICE                      = "CHAR_ICE.png",
    CHAR_VCMS                      = "CHAR_VCMS.png",
    CHAR_VICECUSTOMS               = "CHAR_VICECUSTOMS.png",
    CHAR_VCPD                      = "CHAR_VCPD.png",
    CHAR_FRONT                      = "CHAR_FRONT.png",
    CHAR_COINS                      = "coins.png",
    CHAR_PIZZA                      = "CHAR_PIZZA.png",
    ...
    DIA_CONSTRUCTION                 = "Dia_construction.png",
    ...
    CHAR_247BANHAM                   = "char_247banham.jpg",
    CHAR_247HAWICK                   = "char_247hawick.jpg",
    CHAR_247LITTLESEOUL              = "char_247littleseoul.jpg",
    CHAR_247MONTCHILIAD              = "char_247montchiliad.jpg",
    CHAR_247MORNINGWOOD              = "char_247morningwood.jpg",
    CHAR_247MURRIETA                 = "char_247murrieta.jpg",
    CHAR_247STRAWBERRY               = "char_247strawberry.jpg",
    CHAR_247VESPUCCI                 = "char_247vespucci.jpg",
    CHAR_AUTOREPAIRS                 = "char_autorepairs.jpg",
    CHAR_BCSD                        = "char_bcsd.png",
    CHAR_CONCESSIONNAIRE             = "char_concessionnaire.jpg",
    CHAR_FOURRIERE                   = "char_fourriere.jpg",
    CHAR_GRUPPE6                     = "char_gruppe6.png",
    CHAR_GSMECHANIC                  = "char_gsmechanic.png",
    CHAR_INFORMATEUR                 = "char_informateur.jpg",
    CHAR_JODYS                       = "char_jodys.jpg",
    CHAR_LOSTMCBAR                   = "char_lostmcbar.jpg",
    CHAR_LOTTERY                     = "char_lottery.jpg",
    CHAR_LSPD                        = "char_lspd.png",
    CHAR_MECANO                      = "char_mecano.jpg",
    CHAR_MOSLEY                      = "char_mosley.jpg",
    CHAR_PREF                        = "char_pref.jpg",
    CHAR_WEAZELNEWS                  = "char_weazelnews.jpg",
    LAURENT                          = "LAURENT.gif",
    SERVERLOGO                       = "90Life.png",
    BILLING                          = "billing.png",
    CONCESSIONNAIREBATEAU            = "concessionnairebateau.png",
    NOTIF_Pepite_argent              = "NOTIF_Pepite_argent.png",
    NOTIF_Pepite_cuivre              = "NOTIF_Pepite_cuivre.png",
    NOTIF_Pepite_or                  = "NOTIF_Pepite_or.png",
    ANONYMOUS                        = "ANONYMOUS.png",
    K9DOG                            = "K9DOG.png",
    CHAR_BAHAMAMAMAS                 = "char_bahamamamas.png",
    CHAR_AMMUNATIONPILLBOX           = "char_ammunationpillbox.png",
    FUCK08                           = "fuck08.png",
    ...
    DAVE_BUSTERS                     = "DAVE_BUSTERS.png",
    CHAR_MALIBU                      = "CHAR_MALIBU.png",
    CHAR_OCEANVIEW                   = "CHAR_OCEANVIEW.png",
    CHAR_GREASYCHOPPER               = "CHAR_GREASYCHOPPER.png",
    CHAR_LAMAR2                      = "CHAR_LAMAR2.png",
}