...
function Destroy(name_)
    ...
    if soundInfo[name_] ~= nil and soundInfo[name_].onPlayEnd ~= nil then
        soundInfo[name_].onPlayEnd(getInfo(name_))
    end
...
function Resume(name_)
    ...
    if soundInfo[name_] ~= nil and soundInfo[name_].onPlayResume ~= nil then
        soundInfo[name_].onPlayResume(getInfo(name_))
    end
end
...
function Pause(name_)
    ...
    if soundInfo[name_] ~= nil and soundInfo[name_].onPlayPause ~= nil then
        soundInfo[name_].onPlayPause(getInfo(name_))
    end
end
