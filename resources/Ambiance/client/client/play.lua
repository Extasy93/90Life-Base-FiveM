PlayUrl = function(name_, url_, volume_, loop_)
    SendNUIMessage({
        status = "url",
        name = name_,
        url = url_,
...
PlayUrlPos = function(name_, url_, volume_, pos, loop_)
    SendNUIMessage({
        status = "url",
        name = name_,
        url = url_,
...
RegisterNetEvent('Ambiance:PlayUrl')
AddEventHandler('Ambiance:PlayUrl', function(name_, url_, volume_, loop_)
    SendNUIMessage({
        status = "url",
        name = name_,
        url = url_,
