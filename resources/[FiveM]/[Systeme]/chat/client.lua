...
AddEventHandler('chat:addMessage', function(message)
	--if exports.eCore:IsAnyMenuOpenned() then
		--while exports.eCore:IsAnyMenuOpenned() do
			--Citizen.Wait(1000)
		--end
	--end
...
RegisterNetEvent('Extasy:OpenChat')
AddEventHandler('Extasy:OpenChat', function()
