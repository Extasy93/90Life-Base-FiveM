local Components = {
	...
	{label = 'torse 1',						name = 'torso_2',			value = 0,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15,	textureof = 'torso_1'},
	...
	{label = 'jambes 1',					name = 'pants_2',			value = 0,		min = 0,	zoomOffset = 0.8,		camOffset = -0.5,	textureof = 'pants_1'},
	...
	{label = 'opacité des imperfections',	name = 'bodyb_2',			value = 0,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15},
...
LoadDefaultModel = function(malePed, cb)
...
ApplySkin = function(skin, clothes)
	local playerPed = PlayerPedId()
	...
	if clothes ~= nil then
		for k, v in pairs(clothes) do
			if k ~= 'sex' and k ~= 'mom' and k ~= 'dad' and k ~= 'face' and k ~= 'skin' and k ~= 'age_1' and k ~= 'age_2' and k ~= 'eye_color' and
				k ~= 'beard_1' and k ~= 'beard_2' and k ~= 'beard_3' and k ~= 'beard_4' and k ~= 'hair_1' and k ~= 'hair_2' and k ~= 'hair_color_1' and k ~= 'hair_color_2' and k ~= 'eyebrows_1' and
				k ~= 'eyebrows_2' and k ~= 'eyebrows_3' and k ~= 'eyebrows_4' and k ~= 'makeup_1' and k ~= 'makeup_2' and k ~= 'makeup_3' and k ~= 'makeup_4' and k ~= 'lipstick_1' and k ~= 'lipstick_2' and
				k ~= 'lipstick_3' and k ~= 'lipstick_4' and k ~= 'blemishes_1' and k ~= 'blemishes_2' and k ~= 'blush_1' and k ~= 'blush_2' and k ~= 'blush_3' and k ~= 'complexion_1' and k ~= 'complexion_2' and 
				k ~= 'sun_1' and k ~= 'sun_2' and k ~= 'moles_1' and k ~= 'moles_2' and k ~= 'chest_1' and k ~= 'chest_2' and k ~= 'chest_3' and k ~= 'bodyb_1' and k ~= 'bodyb_2' then
	...
	if Character['face'] ~= nil and Character['skin'] ~= nil and Character['skin'] ~= 0 and Character['face'] ~= nil then
		...
		SetPedHeadBlendData(playerPed, Character['mom'], Character['dad'], nil, Character['mom'], Character['dad'], nil, face_weight, skin_weight, nil, false)
	end
...
ReloadPlayerCloth = function()
	print(LoadSkin)
	ApplySkin(LoadSkin)
end

RegisterNetEvent("Extasy:SaveSkin")
AddEventHandler("Extasy:SaveSkin", function(key, val)
	LoadSkin[key] = val
	TriggerServerEvent("Extasy:SaveSkin", token, json.encode(Character))
end)
