---@type table
local Colour = {
    Background = { Dictionary = "commonmenuu", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 112 },
    LeftArrow = { Dictionary = "commonmenuu", Texture = "arrowleft", X = 7.5, Y = 15, Width = 30, Height = 30 },
    RightArrow = { Dictionary = "commonmenuu", Texture = "arrowright", X = 393.5, Y = 15, Width = 30, Height = 30 },
...
function RageUI.ColourPanelIdentity(Title, Colours, MinimumIndex, CurrentIndex, Action, Index, Style)
...
function RageUI.ColourPanelConcess(Title, Colours, MinimumIndex, CurrentIndex, Callback, Index)
