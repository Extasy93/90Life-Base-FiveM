...
local SettingsSlider = {
    ...
    LeftArrow = { Dictionary = "commonmenuu", Texture = "arrowleft", X = 235, Y = 11.5, Width = 15, Height = 15 },
    RightArrow = { Dictionary = "commonmenuu", Texture = "arrowright", X = 400, Y = 11.5, Width = 15, Height = 15 },
}

function RageUI.SliderProgress2(Label, ProgressStart, ProgressMax, Description, Style, Enabled, Actions)
