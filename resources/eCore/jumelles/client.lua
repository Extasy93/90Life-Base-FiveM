...
--THREADS--
function activejumellesf()

	TriggerEvent("esx_blanchisseur:notify", token, "CHAR_LESTER_DEATHWISH",1,"Mode d'emploi",false,"Utilises la touche D ou S pour (de)zoomer")
...
function HandleZoom(cam)
    ...
    if not (IsPedSittingInAnyVehicle(lPed)) then
        if IsControlJustPressed(0, 9) then -- Scrollup
