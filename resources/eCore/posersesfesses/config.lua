...
fesseConfig.Healing = 3 -- // If this is 0, then its disabled.. Default: 3.. That means, if a person lies in a bed, then he will get 1 health every 3 seconds.
...
fesseConfig.objects = {
	...
	locations = {
		...
		[20] = {object="prop_bench_09", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=-0.5, direction=180.0, bed=false},
		...
		[54] = {object="prop_skid_chair_01", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=-0.5, direction=180.0, bed=false},
		...
		[70] = {object="v_ilev_chair02_ped", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=-0.5, direction=180.0, bed=false},
		[71] = {object="v_ilev_p_easychair", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=-0.5, direction=180.0, bed=false},
		[72] = {object="v_ret_gc_chair03", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=-0.5, direction=180.0, bed=false},
		...
		[87] = {object="v_ilev_fh_kitchenstool", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=-0.5, direction=180.0, bed=false},
		[88] = {object="v_ilev_fh_kitchenstool", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=-0.5, direction=180.0, bed=false},
		...
		[118] = {object="vw_prop_casino_chair_01a", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=-0.5, direction=180.0, bed=false},
		[119] = {object="vw_prop_casino_track_chair_01", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=-0.5, direction=180.0, bed=false},
		[120] = {object="apa_mp_h_din_chair_12", verticalOffsetX=0.0, verticalOffsetY=-0.1, verticalOffsetZ=-0.5, direction=180.0, bed=false}
	}
}

fesseConfig.Text = {
	SitOnChair = '~INPUT_PICKUP~ pour s\'asseoir',
	SitOnBed = '~INPUT_PICKUP~ pour s\'asseoir sur le lit',
	LieOnBed = '~INPUT_PICKUP~ de s\'appuyer sur votre',
	SwitchBetween = '~INPUT_CELLPHONE_LEFT~ ~INPUT_CELLPHONE_RIGHT~ passer de l\'un à l\'autre',
