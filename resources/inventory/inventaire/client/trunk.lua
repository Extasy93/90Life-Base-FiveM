...
AddEventHandler("esx_inventoryhud:openTrunkInventory", function(data, blackMoney, cashMoney, inventory, weapons, model)
    Inv:SetTrunkInventoryData(data, blackMoney, cashMoney, inventory, weapons, model)
    Inv:OpenTrunkInventory()
end)
...
function Inv:SetTrunkInventoryData(data, blackMoney, cashMoney, inventory, weapons, model)
    trunkData = data
...
function Inv:OpenTrunkInventory()
