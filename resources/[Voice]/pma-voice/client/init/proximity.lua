...
local voipMarkerRanges =
{
	...
	[1] = {normal = 0.5,   max = 4.0},
	[2] = {normal = 1.5,   max = 4.0},
	[3] = {normal = 3.0,   max = 13.0},
	[4] = {normal = 6.0,  max = 20.0},
	[5] = {normal = 12.0,  max = 20.0},
}
...
Citizen.CreateThread(function()
	while true do
		...
		if stopTime >= GetGameTimer() then
            ...
            DrawMarker(28, coords.x, coords.y, coords.z, nil, nil, nil, nil, nil, nil, voipMarkerRanges[voiceModeData].normal, voipMarkerRanges[voiceModeData].normal, voipMarkerRanges[voiceModeData].normal, 111, 58, 255, 100, false, false)
		end
	end
end)