function CreateExtendedPlayer(playerId, identifier, group, accounts, inventory, weight, job, job2, loadout, name, coords)
	...
	self.setJob = function(job, grade)
		...
		if ESX.DoesJobExist(job, grade) then
			...
			print(('[ExtendedMode] [^3WARNING^7] Ignorer l\'utilisation invalide de .setJob() pour "%s"'):format(self.identifier))
		end
	end
	...
	self.setJob2 = function(job2, grade2)
		...
		if ESX.DoesJobExist(job2, grade2) then
			...
			print(('[eExtended] [^3WARNING^7] Ignorer l\'utilisation invalide de .setJob2() pour "%s"'):format(self.identifier))
		end
	end
