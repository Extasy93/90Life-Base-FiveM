...
AddEventHandler('playerConnecting', function(name, setKickReason)
	...
	if not id then
		--setKickReason("Impossible de trouver votre SteamID, veuillez relancer FiveM avec Steam d'ouvert ou redémarrer FiveM & Steam si Steam est déjà ouvert")
		--CancelEvent()
	end
end)
...
AddEventHandler('es:firstJoinProper', function()
	...
	Citizen.CreateThread(function()
		...
		if not id then
			--DropPlayer(Source, "Votre SteamID est introuvable, veuillez essayer de vous reconnecter avec Steam ouvert.")
